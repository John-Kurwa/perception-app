...
import WorldHeatMap from "@/components/insights/WorldHeatMap";
import TopicVolatilityIndex from "@/components/insights/TopicVolatilityIndex";
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <Animated.View
        ...
        className="absolute left-0 right-0 z-10 flex-row items-end justify-center px-4 pb-1 bg-background"
      >
